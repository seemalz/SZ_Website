 ...
 * Build: http://www.modernizr.com/download/#-fontface-backgroundsize-borderimage-borderradius-boxshadow-flexbox-hsla-multiplebgs-opacity-rgba-textshadow-cssgradients-cssreflections-shiv-cssclasses-teststyles-testprop-testallprops-prefixes-domprefixes-load
 */
;
window.Modernizr = function(a, b, c) {
    ...
    q.flexbox = function() {
        ...
        return z("background-color:hsla(120,40%,100%,.5)"),C(j.backgroundColor, "rgba") || C(j.backgroundColor, "hsla")
    ...
    return z(""),i = k = null,function(a, b) {
        ...
        function i(a) {
            ...
            var b,c = {},e = a.createElement,f = a.createDocumentFragment,g = h(),j = f(),l = g.length;
        ...
        var c = a.html5 || {},d = /^<|^(?:button|iframe|input|script|textarea)$/i,e,f;
        (function() {
            var c,d = b.createElement("a"),g = a.getComputedStyle,h = b.documentElement,i = b.body || (c = h.insertBefore(b.createElement("body"), h.firstChild));
        ...
        var k = {elements:c.elements || "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video".split(" "),shivCSS:c.shivCSS !== !1,shivMethods:c.shivMethods !== !1,type:"default",shivDocument:j};
        a.html5 = k,j(b)
